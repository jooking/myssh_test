...
public class RecorderService extends Service implements MediaRecorder.OnErrorListener {
    ...
    private void localStartRecording(int outputfileformat, String path, boolean highQuality,
        ...
        if (mRecorder == null) {
            ...
            if (outputfileformat == MediaRecorder.OutputFormat.THREE_GPP) {
                ...
                if (!highQuality) {
                	mRecorder.setAudioEncodingBitRate(AudioFormat.ENCODING_PCM_8BIT);//highQuality?AudioFormat.ENCODING_PCM_16BIT:
				}
    ...
    private void showRecordingNotification() {
        Notification notification = new Notification(android.R.drawable.presence_audio_busy,
               "ÕýÔÚÂ¼Òô¡£¡£¡£", System.currentTimeMillis());// getString(R.string.notification_recording)
    ...
    private void showLowStorageNotification(int minutes) {
        ...
        if (mLowStorageNotification == null) {
            mLowStorageNotification = new Notification(android.R.drawable.presence_audio_busy,
            		 "ÕýÔÚÂ¼Òô¡£¡£¡£", System.currentTimeMillis());
    ...
    private void showStoppedNotification() {
        ...
        Notification notification = new Notification(android.R.drawable.presence_audio_busy,//R.drawable.stat_sys_call_record
               "Â¼ÒôÍ£Ö¹", System.currentTimeMillis());
